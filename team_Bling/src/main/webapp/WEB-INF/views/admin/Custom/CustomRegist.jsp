			...
			<table class="table">
				...
				<tr>
					...
					<td>
						<div class="form-check">
						  <input class="form-check-input" type="radio" name="kind" id="kind1">
						  <label class="form-check-label" for="kind">
						    	목걸이 
						  </label>
						</div>
						<div class="form-check">
						  <input class="form-check-input" type="radio" name="kind" id="kind2" checked>
						  <label class="form-check-label" for="kind">
						    	팔찌
						  </label>
						</div>
				...
				<tr>
					...
					<td >
						...
						<div class="form-check">
						  <input class="form-check-input" type="radio" name="type" id="type3" checked>
						  <label class="form-check-label" for="type">
						    	장식
						  </label>
						</div>
