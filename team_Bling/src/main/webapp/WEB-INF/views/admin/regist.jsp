...
<body>
	...
	<ul class="nav nav-pills">
	  ...
	  <li class="nav-item dropdown">
	   ...
	   <li class="nav-item dropdown">
	    ...
	    <ul class="dropdown-menu">
	      <li><a class="dropdown-item" href="/Admin/list.do">상품 리스트</a></li>
	...
	<div class="d1">
		<div class="quickmenu">
			  <ul>
			 	<li><a href="#">홈</a></li>
			    <li><a href="/Admin/list.do">리스트</a></li>
		...
		<div class="d2">
			...
			<div id="add"></div>
			<form action="/Admin/insertImg.do" method="post" enctype="multipart/form-data">
				<h3>이미지</h3>
					<div class="mb-3">
