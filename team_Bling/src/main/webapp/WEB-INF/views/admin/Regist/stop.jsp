...
<section>
	...
	<div style="text-align:center;">
		<span class="title">판매중지 상품 리스트&ensp;</span>
		<select name="kind" id="kind" onchange="location.href=this.value">
			<option value="/team_Bling/Ad_regist/stop.do?page=1&kind=A">모든 제품</option>
			<option value="/team_Bling/Ad_regist/stop.do?page=1&kind=R">반지</option>
			<option value="/team_Bling/Ad_regist/stop.do?page=1&kind=E">귀걸이</option>
			<option value="/team_Bling/Ad_regist/stop.do?page=1&kind=N">목걸이</option>
			<option value="/team_Bling/Ad_regist/stop.do?page=1&kind=B">팔찌</option>
		</select>
		...
		<nav aria-label="Page navigation">
			<ul class="pagination justify-content-center">
				...
				<c:set var="prev" value="${pm.startPage -1}"/>
					<a class='page-link' aria-label='Previous' href="/team_Bling/Ad_regist/stop.do?page=${prev}&kind=${pm.kind}">
				...
				<c:forEach var="pageNum" begin="${pm.startPage}" end="${pm.endPage}">
					...
					<li class="page-item active">	
						<a class="page-link pointer" href="/team_Bling/Ad_regist/stop.do?page=${pageNum}&kind=${pm.kind}">
							<c:out value="${pageNum}"/>
						</a>
					</li>
					</c:if>
				...
				<li class='page-item'>
					<a class='page-link' aria-label='Next' href="/team_Bling/Ad_regist/stop.do?page=${pm.endPage + 1}&kind=${pm.kind}">
