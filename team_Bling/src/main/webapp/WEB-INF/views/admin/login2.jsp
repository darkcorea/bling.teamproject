		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8" id="formDiv">
					<form name="form" action="/Admin/check2.do" method="post">
						<div id="pwDiv">	
							<div id="formText">
						...
						<div id="cautionDiv">
							<c:if test="${msg == 'failure'}">
								<div id="caution" style="color: red;">비밀번호가 잘못 입력 되었습니다.</div>
								<div id="caution" style="color: red;">비밀번호를 정확히 입력해 주세요.</div>
							</c:if>
						</div>
						<div id="btnDiv">
