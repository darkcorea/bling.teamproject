		...
		<div class="w-100 explan">
			...
			<div class="text1">
				<div class="text2">
					...
					<!-- 바로구매, 장바구니 버튼 -->
					<div class="btn-two">
						<button type="button" class="btn btn-danger" onclick="order()">바로구매</button>
						<button type="button" class="btn btn-light">장바구니</button>
						&ensp;<i class="bi bi-suit-heart" id="heart"
							onclick="heart(${detail.pidx})"></i>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function order(){
		...
		if(option == ""){
		  ...
		  // 선택되 옵션과 총 가격을  ArrayLlst에  담아서 JSON형태로 변환
		  let option1 = 0;
	      let quntity = 0;
	      let List = new Array;
	      ...
	      // 폼을 생성해서 ArrayList를 원하는 url로 보내기
